...
public class Monster : MonoBehaviour {
	...
	public void Die() {
		...
		if (!isStructure) {
			...
			EnergyController.s.AwardEnergy(energyReward, transform.position, isComingFromLeft);
	...
	public void UpdateMonster() {
		...
		try {
			...
			//do nothing. Some of the sprites do not support this color value thing
		}
